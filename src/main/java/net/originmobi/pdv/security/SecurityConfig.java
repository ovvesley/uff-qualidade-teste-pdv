...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
  ...
  private static final String CARTAO_LANCAMENTOS = "/cartaolancamentos";
  private static final String REGRAS = "/regras";
  private static final String TRIBUTACAO = "/tributacao";
  ...
  protected void configure(HttpSecurity http) throws Exception {
    http.csrf().disable()
      ...
      // Combine the /tributacao patterns into one with multiple roles:
      .antMatchers(TRIBUTACAO).hasAnyRole("LISTA_TRIBUTAÇÃO", "CADASTRA_TRIBUTACAO")

      // Combine the /regras patterns into one with multiple roles:
      .antMatchers(REGRAS).hasAnyRole("CADATRAR_REGRA_TRIBUTACAO", "EXCLUIR_REGRA_TRIBUTACAO", "EDITAR_REGRA_TRIBUTACAO")
      ...
      // Combine the /cartaolancamentos patterns into one:
      .antMatchers(CARTAO_LANCAMENTOS).hasAnyRole("GERENCIAR_CARTOES", "ANTECIPAR_CARTAO", "PROCESSAR_CARTAO")
